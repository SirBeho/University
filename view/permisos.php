...
<main class="h-full w-full flex flex-col bg-gray-100 px-4">
    ...
    <div class="w-full bg-white rounded-md">
       <span class="block w-full border-b p-2 ">Informacion de Persmisos</span>
        ...
        <table id="table_id" class="display table table-bordered  " style="width:100%">
            ...
            <tbody>
                        <tr>
                            ...
                            <td>61</td>
                            <td>2011-04-25</td>
                            <td onclick=""><img data-modal-target="permiso-modal" data-modal-toggle="permiso-modal"  src="../svg/edit.svg" alt=""></td>
                        </tr>
                        <tr>
...
<?php include  '../model/modalPermiso.php'?>
