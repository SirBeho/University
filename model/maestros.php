  ...
  <tr>
                        ...
                        <td>
                             <div class="flex gap-2 w-12 justify-center overflow-hidden bg-transparent">
                                <div>
                                    <img onclick="EditarMaestros(<?php echo $datos['us_id'],$datos['materia_id'],$datos['materias'] ?>,)" data-modal-target="maestro-modal" data-modal-toggle="maestro-modal" class="cursor-pointer" src="../svg/edit.svg" alt="">
                                </div>
                                <div>
